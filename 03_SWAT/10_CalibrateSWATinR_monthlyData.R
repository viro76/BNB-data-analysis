...
setwd("E:/ArcSWAT_Examples/4_Gerda/GerdaNewLU/Scenarios/WLRC-NwLU_31yrs_2nysk_mon/TxtInOut")
...
Qsim <- subsim[subsim$V2==11,7]                    # Select data from column 7 for each V2==15
Qsim <- Qsim[1:348]                                   
#Qsim <- Qsim*2592000
